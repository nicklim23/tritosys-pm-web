              ...
              <form id="form1">
                ...
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" value="{{$site->site_id}}" id="site_id" name="site_id">
                  </div>
                  <div class="col-md-6">
                    <label for="name" class="col-form-label">
                      Site Name <b style="color:red;">*</b>
                    </label>
                    <input class="form-control" type="text" value="{{$site->name}}" id="name" name="name">
                  </div>
                </div>
                <div class="form-group row">
                  <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" value="{{$site->person_in_charge}}" id="person_in_charge" name="person_in_charge">
                  </div>
                  <div class="col-md-6">
                    <label for="address" class="col-form-label">
                      Address <b style="color:red;">*</b>
                    </label>
                    <input class="form-control" type="text" value="{{$site->address}}" id="showaddress" name="address">
